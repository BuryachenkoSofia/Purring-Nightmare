...
public class DoorPointer : MonoBehaviour
{
    ...
    void Update()
    {
        iconPointer.gameObject.SetActive(player.gameObject.GetComponent<PlayerControl>().doorOpen);
        text.SetActive(!player.gameObject.GetComponent<PlayerControl>().doorOpen);
